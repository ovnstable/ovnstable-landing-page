...
import StepCards from "@/components/tools/StepCards";
import StepCardsMobile from "@/components/tools/StepCardsMobile";
import PartnersCarousel from "@/components/tools/PartnersCarousel";
